...
struct dtPolyDetail
{
	...
	dtPolyDetailIndex vertCount;					///< Number of vertices in the detail mesh.
	dtPolyDetailIndex triCount;						///< Number of triangles.
};
...
struct dtMeshTile
{
	...
	dtPolyDetailIndex* detailTris;				///< Pointer to detail triangles (will be updated when tile added).
